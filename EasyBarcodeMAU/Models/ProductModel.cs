namespace EasyBarcodeMAU.Models;
    public class ProductModel : BaseViewModel {
        ...
        public List<ProductItemBase> MyItems { get; set; } = new List<ProductItemBase>
        {
            ...
            new ProductItemBase { Id = 5, DefterNo = 671321512, DepoGirisi = DateTime.Now, MusteriAd = "ARMUT", UrunCins = "Kitap", UrunAdet = 300, UrunAgirlik = 250 , DepoKonum = "Isparta" },
            new ProductItemBase { Id = 6, DefterNo = 781321512, DepoGirisi = DateTime.Now, MusteriAd = "Hepsiburada", UrunCins = "Kitap", UrunAdet = 1000, UrunAgirlik = 250 , DepoKonum = "Erzincan" },
            new ProductItemBase { Id = 7, DefterNo = 891321512, DepoGirisi = DateTime.Now, MusteriAd = "Getir", UrunCins = "Kulaklık", UrunAdet = 400, UrunAgirlik = 2000 , DepoKonum = "Muğla" },
        };
    }
namespace EasyBarcodeMAU.Models;
    public class ProductModel : BaseViewModel {
        ...
        {
            new ProductItemBase { Id = 1, DefterNo = 123321456, DepoGirisi = DateTime.Now, MusteriAd = "Beko", UrunCins = "KALEM", UrunAdet = 7839858, UrunAgirlik = 195 , DepoKonum = "Yakacık yeni mah veysel sokak no 9 daire 4 KARTAL / İSTANBUL Hanımeli sokak no 6 daire 4 Düzce / Kaynaşlı", RequiredCount=10 },
